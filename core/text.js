  ...
  email: {
    ...
    pivotProposal: function (snapshot, invitee, link) {
      ...
      return {
        ...
        body: [
          "The first times can't satisfy the success rule, so here's a rescue slate.",
    ...
    requiredStuck: function (snapshot, invitee, link) {
      ...
      return {
        ...
        body: [
          ...
          "- demote them to optional (they stop counting toward the success rule)",
          "- chase them directly",
          "- cancel the poll",
          "",
          "Choose: " + link,
    ...
    escalate: function (snapshot, invitee, link) {
      ...
      return {
        ...
        body: [
          ...
          "",
          "Your options:",
          "- book one of the remaining times anyway (despite the failed rule)",
          "- cancel the poll",
          "- or take it offline and talk to people directly",
          "",
          "Decide: " + link,
          "",
          signoff(poll)
